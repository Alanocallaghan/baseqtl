...
class model_noGT_nb_ase : public prob_grad {
private:
    int N;
    int G;
    int A;
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int r = pos; r <= ((pos + get_base1(sNB,i,"sNB",1)) - 1); ++r) {
                    ...
                    if (as_bool(logical_eq(get_base1(get_base1(ASEi,i,"ASEi",1),1,"ASEi",2),1))) {
                        ...
                        for (int x = 1; x <= get_base1(h2g,r,"h2g",1); ++x) {
                            ...
                            stan::math::assign(p, stan::model::deep_copy((logical_eq(get_base1(gase,posl,"gase",1),-(1)) ? stan::math::promote_scalar<local_scalar_t__>((1 - ebjd)) : stan::math::promote_scalar<local_scalar_t__>(p) )));
                ...
                stan::math::assign(pos, stan::model::deep_copy((pos + get_base1(sNB,i,"sNB",1))));
            }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
