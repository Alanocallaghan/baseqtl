...
namespace model_noGT_nb_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_noGT_nb");
    reader.add_event(137, 135, "end", "model_noGT_nb");
    return reader;
}
#include <stan_meta_header.hpp>
class model_noGT_nb
  : public stan::model::model_base_crtp<model_noGT_nb> {
private:
        int N;
        int G;
        int K;
        ...
        vector_d mixP;
public:
    model_noGT_nb(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_noGT_nb_namespace::model_noGT_nb";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_noGT_nb_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_noGT_nb_namespace::model_noGT_nb stan_model;
#ifndef USING_R
