...
class model_noGT_nb_ase_refbias
  : public stan::model::model_base_crtp<model_noGT_nb_ase_refbias> {
private:
        int N;
        int G;
        int A;
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int r = pos; r <= ((pos + get_base1(sNB, i, "sNB", 1)) - 1); ++r) {
                    ...
                    stan::math::assign(lmu, (logical_eq(stan::math::fabs(get_base1(gNB, r, "gNB", 1)), 1) ? stan::math::promote_scalar<local_scalar_t__>(((lmu + stan::math::log1p(ebj)) - stan::math::log(2))) : stan::math::promote_scalar<local_scalar_t__>(lmu) ));
                    ...
                    if (as_bool(logical_eq(get_base1(get_base1(ASEi, i, "ASEi", 1), 1, "ASEi", 2), 1))) {
                        ...
                        for (int x = 1; x <= get_base1(h2g, r, "h2g", 1); ++x) {
                            ...
                            stan::math::assign(p, (logical_eq(get_base1(gase, posl, "gase", 1), -(1)) ? stan::math::promote_scalar<local_scalar_t__>((1 - get_base1(esum, posl, "esum", 1))) : stan::math::promote_scalar<local_scalar_t__>(p) ));
