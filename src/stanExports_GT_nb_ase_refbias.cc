...
#include "stanExports_GT_nb_ase_refbias.h"

RCPP_MODULE(stan_fit4GT_nb_ase_refbias_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_GT_nb_ase_refbias")
