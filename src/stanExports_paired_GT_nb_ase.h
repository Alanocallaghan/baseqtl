...
class model_paired_GT_nb_ase : public prob_grad {
private:
    int N;
    int A;
    int L;
            ...
            for (int i = 1; i <= A; ++i) {
                ...
                for (int t = 1; t <= 2; ++t) {
                    ...
                    if (as_bool(logical_gt(get_base1(get_base1(m,i,"m",1),t,"m",2),0))) {
                        ...
                        stan::math::assign(p, stan::model::deep_copy((logical_eq(get_base1(gase,i,"gase",1),-(1)) ? stan::math::promote_scalar<local_scalar_t__>((1 - esum)) : stan::math::promote_scalar<local_scalar_t__>(p) )));
