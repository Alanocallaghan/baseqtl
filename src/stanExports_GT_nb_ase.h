...
class model_GT_nb_ase : public prob_grad {
private:
    int N;
    int A;
    int L;
...
public:
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1>  p(static_cast<Eigen::VectorXd::Index>(A));
            ...
            for (int i = 1; i <= A; ++i) {
                ...
                stan::model::assign(p, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            stan::model::deep_copy((logical_eq(get_base1(gase,i,"gase",1),-(1)) ? stan::math::promote_scalar<local_scalar_t__>((1 - debj)) : stan::math::promote_scalar<local_scalar_t__>(get_base1(p,i,"p",1)) )), 
                            "assigning variable p");
