...
namespace model_GT_nb_ase_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_GT_nb_ase");
    reader.add_event(82, 80, "end", "model_GT_nb_ase");
    return reader;
}
#include <stan_meta_header.hpp>
class model_GT_nb_ase
  : public stan::model::model_base_crtp<model_GT_nb_ase> {
private:
        int N;
        int A;
        int L;
        ...
        vector_d mixP;
public:
    model_GT_nb_ase(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_GT_nb_ase_namespace::model_GT_nb_ase";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> p(A);
            ...
            local_scalar_t__ debj(DUMMY_VAR__);
            (void) debj;  // dummy to suppress unused var warning
            stan::math::initialize(debj, DUMMY_VAR__);
            stan::math::fill(debj, DUMMY_VAR__);
            ...
            stan::math::assign(debj, (ebj / (1 + ebj)));
            ...
            for (int i = 1; i <= A; ++i) {
                ...
                stan::model::assign(p, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (logical_eq(get_base1(gase, i, "gase", 1), 1) ? stan::math::promote_scalar<local_scalar_t__>(debj) : stan::math::promote_scalar<local_scalar_t__>(0.5) ), 
                            "assigning variable p");
                current_statement_begin__ = 69;
                stan::model::assign(p, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (logical_eq(get_base1(gase, i, "gase", 1), -(1)) ? stan::math::promote_scalar<local_scalar_t__>((1 - debj)) : stan::math::promote_scalar<local_scalar_t__>(get_base1(p, i, "p", 1)) ), 
                            "assigning variable p");
                ...
                for (int r = pos; r <= ((pos + get_base1(s, i, "s", 1)) - 1); ++r) {
                    ...
                    stan::model::assign(ltmp, 
                                ...
                                (beta_binomial_log(get_base1(n, r, "n", 1), get_base1(m, i, "m", 1), (get_base1(p, i, "p", 1) * theta), ((1 - get_base1(p, i, "p", 1)) * theta)) + stan::math::log(get_base1(pH, r, "pH", 1))), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_GT_nb_ase_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_GT_nb_ase_namespace::model_GT_nb_ase stan_model;
#ifndef USING_R
