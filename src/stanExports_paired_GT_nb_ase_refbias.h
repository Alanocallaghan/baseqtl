...
class model_paired_GT_nb_ase_refbias
  : public stan::model::model_base_crtp<model_paired_GT_nb_ase_refbias> {
private:
        int N;
        int A;
        int L;
        ...
        vector_d pH;
        std::vector<std::vector<double> > ai0;
        std::vector<std::vector<double> > sdai0;
        matrix_d cov;
        vector_d aveP;
        vector_d sdP;
        vector_d mixP;
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            pos__ = 0;
            size_t ai0_k_0_max__ = L;
            size_t ai0_k_1_max__ = 2;
            for (size_t k_1__ = 0; k_1__ < ai0_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < ai0_k_0_max__; ++k_0__) {
                    ai0[k_0__][k_1__] = vals_r__[pos__++];
                }
            }
            ...
            pos__ = 0;
            size_t sdai0_k_0_max__ = L;
            size_t sdai0_k_1_max__ = 2;
            for (size_t k_1__ = 0; k_1__ < sdai0_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < sdai0_k_0_max__; ++k_0__) {
                    sdai0[k_0__][k_1__] = vals_r__[pos__++];
                }
            }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        validate_non_negative_index("rai0", "L", L);
        validate_non_negative_index("rai0", "2", 2);
        context__.validate_dims("parameter initialization", "rai0", "matrix_d", context__.to_vec(L,2));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> rai0(L, 2);
        size_t rai0_j_2_max__ = 2;
        size_t rai0_j_1_max__ = L;
        for (size_t j_2__ = 0; j_2__ < rai0_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < rai0_j_1_max__; ++j_1__) {
                rai0(j_1__, j_2__) = vals_r__[pos__++];
            }
        }
        try {
                ...
                for (int t = 1; t <= 2; ++t) {
                    ...
                    if (as_bool(logical_gt(get_base1(get_base1(m, i, "m", 1), t, "m", 2), 0))) {
                        ...
                        for (int r = pos; r <= ((pos + get_base1(s, i, "s", 1)) - 1); ++r) {
                            ...
                            stan::math::assign(p, (logical_eq(get_base1(gase, i, "gase", 1), -(1)) ? stan::math::promote_scalar<local_scalar_t__>((1 - get_base1(esum, r, "esum", 1))) : stan::math::promote_scalar<local_scalar_t__>(p) ));
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> rai0 = in__.matrix_constrain(L, 2);
        size_t rai0_j_2_max__ = 2;
        size_t rai0_j_1_max__ = L;
        for (size_t j_2__ = 0; j_2__ < rai0_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < rai0_j_1_max__; ++j_1__) {
                vars__.push_back(rai0(j_1__, j_2__));
            }
        }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_2__ = 0; j_2__ < rai0_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < rai0_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "rai0" << '.' << j_1__ + 1 << '.' << j_2__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        size_t ui_j_1_max__ = N;
