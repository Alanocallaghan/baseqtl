...
#include "stanExports_paired_GT_nb_ase.h"

RCPP_MODULE(stan_fit4paired_GT_nb_ase_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_paired_GT_nb_ase")
