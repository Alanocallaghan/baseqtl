...
* **Description**
    ...
    1. bt1 and bt2 corespond to the two treatments/condition, as ordered in counts.f and vcf inputs.
    ...
    1. When ba significant implies a significant eQTl efect in one or both treatments. If bd is significant, there is evidence for condition specific effect, likely the eQTL effect is detected in one condition only.
